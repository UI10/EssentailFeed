...
final class LoadFeedFromRemoteUseCaseTests: XCTestCase {
    ...
    private func makeSUT(url: URL = URL(string: "any-url.com")!,file: StaticString = #filePath, line: UInt = #line) -> (sut: RemoteFeedLoader, client: HTTPClientSpy) {
        let client = HTTPClientSpy()
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.load { receviedResult in
            ...
            default:
                XCTFail("Expected result \(expectedResult) got \(receviedResult)", file: file, line: line)
            }
            exp.fulfill()
        }
